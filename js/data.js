const data = [
  ...
  },
  {
    ...
    img2: "../plantas/img/planta17_2.JPG",
    img3: "../plantas/img/planta17_3.JPG",
    desc:
      "De las más bonitas e imponentes, sus hojas brillantes tienen tonos en verde claro con las nervaduras y tallo en color blanco. Las hojas pueden ser más anchas o más largas y estrechas, pero siempre acabadas en punta. Las matas pueden alzarse hasta el metro de altura, también existen variedades compactas de 13 a 17 centímetros, lo que facilita el placer de coleccionarlas. Además, combinan y conviven bien con otras plantas de interior de similares requerimientos.",
    care:
  ...
  },
  {
    ...
    desc:
      "La pieza combina dos sedums sutilmente distintos (adolphii y nussbaumerianum), estas especies se caracterizan por formar pequeños arbustos (es una planta subarbustiva) con tallos ramificados y colgantes (los tallos más pequeños mantienen un porte erecto temporal). Generalmente crecen sobre sustratos rocosos a los cuales se adhieren fuertemente. <br><br>El follaje se caracteriza por tener forma lanceolada con un ligera inclinación hacia arriba y presentar una coloración verde clara que puede tornarse rojiza (específicamente color cobre) si reciben mucha luz. Puedes diferenciar las especies por la forma de sus hojas, la adolphii tiene hojas menos alargadas y más anchas que la Nussbaumerianum. <br><br>¿Logras identificarlas?",
    care:
  ...
  },
  {
    ...
    desc:
      'Coloquialmente conocida como "lengua de suegra", es originaria de África Occidental. Presenta hojas carnosas, sin tallos ni soportes, estrechas y largas, jaspeadas de verde y de blanco, con el borde amarillo. <br><br>Esta planta merece alguna mención más porque se trata de una quimera, es decir que las células del borde de la planta mutan presentando un número de cromosomas diferente de lo normal. En la práctica existe una alternancia entre las células normales y las células mutadas. De hecho, el borde blanco / amarillo corresponde a las células mutadas, carentes de clorofila, que se encuentran entre los tejidos normales formados por las células normales.',
    care:
  ...
  },
  {
    ...
    img3: null,
    desc:
      "¡Una combinación que nos encanta! En esta variedad de Monstera, la hoja es pequeña y necesita más soporte, por lo que sembramos dos varas de Serenito. Según vayan creciendo ambas plantas, se entrelazarán y la combinación de colores realzará la belleza de cada una. <br><br><strong>Estructura de madera incluida*</strong>",
    care:
